                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group localization">
                            ...
                            <textarea rows="3" class="form-control" name="description[]" placeholder="Введмте описание"> </textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group localization localizationLast">
                            ...
                            <input class="form-control" name="slug[]" placeholder="Введмте ссылку">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
