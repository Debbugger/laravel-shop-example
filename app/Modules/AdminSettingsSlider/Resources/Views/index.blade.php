...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Добавление слайда</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <form method="post" action="{{route('adminSettingsSliderCreate')}}" id="form-add" class="form-modal">
    ...
    <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Редактирование слайда</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-data">
                    <form method="post" action="{{route('adminSettingsSliderEdit')}}" id="form-edit" class="form-modal">
                        <img class="preload-category" src="{{asset('admin-styles/images/loader.gif')}}">
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-md-6">
                        <form method="post" action="{{route('adminSettingsSliderDelete')}}" id="form-delete">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header justify-content-between ">
                            <div class="card-title ">Таблица слайдов</div>
                        ...
                        <form id="edit-form-img" enctype="multipart/form-data" action="{{route('adminSettingsSliderImage')}}">
                            <input type="file" name="image" data-id="" data-type="table" hidden/>
                            <input name="id" data-type="table" hidden/>
                        </form>
                        <form id="changeShow" class="form-edit-show" action="{{route('adminSettingsSliderChangeShow')}}">
    ...
    <script>
        $(document).ready(function () {
            ...
            let data_table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{route('adminSettingsSliderTable')}}',
                columns: [
                    {data: 'id', 'title': '#'},
                ...
                (new SaveTrait({selector: '#get-modal-edit',  actionUrl: '{{route('adminSettingsSliderModal')}}'}).setAdditionalFailCallback(function (callback) {
                    $('#form-edit').html(callback);
                }));

            });

            (new SaveTrait({selector: '.get-modal-add', selectorType: 'click', actionUrl: '{{route('adminSettingsSliderModal')}}'}).setAdditionalData(function (callback) {
                return callback;
