...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Добавление характеристики</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <form method="post" action="{{route('adminManagementSpecificationCreate')}}" id="form-add" class="form-modal">
    ...
    <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Редактирование характеристики</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <form method="post" action="{{route('adminManagementSpecificationEdit')}}" id="form-edit" class="form-modal">
                    <img class="preload-category" src="{{asset('admin-styles/images/loader.gif')}}">
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-md-6">
                        <form method="post" action="{{route('adminManagementSpecificationDelete')}}" id="form-delete">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header justify-content-between">
                            <div class="card-title">Таблица характеристик</div>
                        ...
                        <form id="changeShow" class="form-edit-show" action="{{route('adminManagementSpecificationChangeShow')}}">
...
@push('scripts')
    ...
    <script>
        ...
        let data_table = $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{route('adminManagementSpecificationTable')}}',
            columns: [
                {data: 'id', 'title': '#'},
                {data: 'filter', 'title': 'Активен', className: "icon-center changeShow"},
                {data: 'name', 'title': 'Имя'},
            ...
            (new SaveTrait({selector: '#get-modal-edit', actionUrl: '{{route('adminManagementSpecificationModal')}}'}).setAdditionalFailCallback(function (callback) {
        ...
        (new SaveTrait({selector: '.get-modal-add', selectorType: 'click', actionUrl: '{{route('adminManagementSpecificationModal')}}'}).setAdditionalData(function (callback) {
            return callback;
