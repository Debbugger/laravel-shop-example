<form method="post" class="send-form" action="{{route('adminCreateOrEditSeo')}}">@csrf
    <input type="number" hidden name="id" value="{{$item ? $item->id : null}}">
    <div class="modal-header">
        <h4 class="modal-title">{{$item ? 'Редактирование SEO: '. parseMultiLanguageString($item->meta_title): 'Добавление SEO'}}</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$item ? $item->address : null}}" name="address" placeholder="Укажите адрес"/>
